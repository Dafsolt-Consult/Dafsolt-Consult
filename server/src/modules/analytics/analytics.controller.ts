...
async function enrollmentTrend(tenantId: string) {
...
async function attendanceTrend(tenantId: string) {
...
async function feeCollectionByTerm(tenantId: string) {
  const session =
...
async function examPerformance(tenantId: string) {
